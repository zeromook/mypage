						...
						<div class="col-md-12">
							<section class="card">
								<div class="card-body text-center"
											...
											<table class='updatetable'>
												...
												<tr>
													...
													<td width="154" class="normal"><input type="password"
														name="pw" id="userPass"></td>
													<td class="normalbold tb_ttl">
														<div align="center">PW 확인</div>
													</td>
													<td width="160" class="normal"><input type="password"
														id="userPass2"></td>
												</tr>
												<tr>
													<td class="normalbold tb_ttl">
													...
													<c:forEach var="item" items="${list}">
														...
														<div class="card">
															...
															<div id="cardContent"
																...
																<div id="likeCount" style="color: blue;">좋아요
																	${item.board_like_count}개</div>
									...
									<div id="">
										<!-- ########## 회원 리스트  ########## -->
										<table id="ChangMyInfo" class="sese" border="2"
											style="display: none;">
											<!-- 여기에 ajax에서 동적으로 생성한 tr>td가 들어감 -->
										</table>
									</div>
