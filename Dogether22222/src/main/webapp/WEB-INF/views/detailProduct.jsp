	...
	<!-- nav바---------------------------------------------------------- -->
      ...
      <div class="main">
        <section class="module">
          <div class="container">
            <div class="row">
              <div class="col-sm-6 mb-sm-40"><a class="gallery" href="./resources/img/shoppingmall/images/shop/product-7.jpg"><img src="./resources/img/shoppingmall/productimgs/${Product_fname}" width="665" height="750" alt="상품사진"></a>
                  
              </div>
              <div class="col-sm-6">
                <div class="row">
                  <div class="col-sm-12">
                    <h1 class="product-title font-alt">${ProductName}상품명</h1>
                  </div>
                </div>
                
                <div class="row mb-20">
                  <div class="col-sm-12">
                    <div class="price font-alt"><span class="amount">${ProductPrice}20,000</span></div>
                  </div>
                </div>
                <div class="row mb-20">
                  <div class="col-sm-12">
                    ...
                    <div class="price font-alt"><span class="amount">${ProductContent}우리집 강아지는 숯불강아지 핫도그 밥그릇 지아이조 지아이에스 콘트롤러 밥 저녁은 무슨 메뉴일까요 김치볶음밥 계란볶음 탕수육 양장피 1인분 1만 8천원</span></div>
                  </div>
                </div>
                <div class="row mb-20">
                  ...
                  <div class="col-sm-8"><a class="btn btn-lg btn-block btn-round btn-b" href="Cart">Add To Cart</a></div>
                </div>
                <div class="row mb-20">
                </div>
              </div>
